        ...
        <div className="flex items-center justify-between max-w-8xl mx-auto py-4 transition-all">
          ...
          <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-white/55">
            ...
            >
              ...
              Cart
              <span
                className={`absolute -top-1 left-3 text-[8px] text-white bg-slate-600 size-3.5 rounded-full flex items-center justify-center transition-opacity ${
                  mounted && cartCount > 0 ? "opacity-100" : "opacity-0"
                }`}
              >
                {mounted ? cartCount : ""}
              </span>
          ...
          <div className="sm:hidden flex items-center gap-4">
            ...
            >
              <ShoppingCart size={16} />
              <span
                className={`absolute -top-1 right-2 text-[8px] text-white bg-slate-600 size-3.5 rounded-full flex items-center justify-center transition-opacity ${
                  mounted && cartCount > 0 ? "opacity-100" : "opacity-0"
                }`}
              >
                {mounted ? cartCount : ""}
